...
public class CE extends JPanel
{
                ...
                if(a.equals("1")){
                    ...
                    if(b.equals("1")){
                        ...
                        if(c.equals("1")&&canBuy(5)){
                            ...
                            if(!waterBought){
                                println("{Bartender} Pick whatever one you like...",30,500,"Bar 8");
                ...
                //Healer
                    ...
                    while(cont){
                        ...
                        if(b.equals("1")&&canBuy(30)&&player.healthPercentage()!=1.0){
                            ...
                            println("You buy a Health Potion",20);
                            healthPot++;
                        }
                        else if(b.equals("4")&&canBuy(25)&&manaPot<5){
                            println("You bought a Mana potion",20);
                            manaPot++;
                        }
                        else if(b.equals("5")&&canBuy(15)){
                            println("You bought Ala's tonic",20);
                            statusPot++;
                        }
                        else if(b.equals("0")){
                            cont=false;
    ...
    public void skeletonCheck() throws Exception{
        if(monster.getId()==5&&monster.getHealth()<=0&&!sRevived){
            ...
            println("{Skeleton} I ain't dead yet!",30,0,"Skeleton 4");
    ...
    public void goonCheck() throws Exception{
        ...
        if(!bossTimer&&(monster.getId()==9001||monster.getId()==9002)){
            ...
            println("{King Joe} Well done, go and rest my underling.",20);
            draw("King");mname="King";
            monster.printStats();
            monster.setAID(0);
    ...
    public void attack() throws Exception{
        ...
        if(monster.getId()==3&&RN.nextInt(10)<2)
        {
            println("{Skeleton} That one really tickled my funny bone!",30,0,"Skeleton 2");
        }
    ...
    public void rest() throws Exception{
        ...
        if(!cursed){// Yes, even curse will prevent this.
            ...
            print(" and regenerated "+regen+" mana",20);
        }
        System.out.println();
    }
    ...
    public void initializeMonster(int id) throws Exception{
        ...
        if(id==1){
            ...
            System.out.println("You find a "+monster.getName().substring(3)+"");
            println("{Skeleton} I got a bone to pick with you big boy...",30,0,"Skeleton 1");
            e.printSkeleton();
        }
        else if(id==4){
            monster=new Monster(130,130,7,3,2,10,"The Wolf",4);
            System.out.println("You encounter a "+monster.getName().substring(3)+"");
            if(line%2==1){playEffect("Wolf 1");}
            else{playEffect("Wolf 6");}
            e.printWolf();
        }
        else if(id==11){
        ...
        else if(id==13)
        {
            ...
            println("{Orc} Someone's been a bad boy...",30,0,"Orc 1");
            e.printOrc();
        }
        else if(id==14)
        {
        ...
        else if(id==102)
        {
            ...
            else if(temp==3)
            {
                ...
                println("{Winter Witch} Oh my, who might you be?",30,0,"WWitch 1");
            }
            else
            {
                monster = new Monster(300,300,8,4,20,5,"The Spring Witch",105);
                println("{Spring Witch} I love this season, lets play!",30,0,"SWitch 3");
            }
            e.printWitch();
        }
        else if(id==1001)
    ...
    public boolean mCast(int id) throws Exception{
        ...
        if(id==3&&monster.getAID()==0&&monster.healthPercentage()<=.9){//Skeleton
            playEffect("Skeleton 3");
            draw("Angry");draw("SkeletonThrow");draw("Bleeding");
        ...
        if(id==4&&monster.getAID()==0&&RN.nextInt(100)<=20){//Wolf
            draw("Angry");
            e.printAngryWolf();
            if(RN.nextInt(2)%2==1){playEffect("Wolf 1");}
            else {playEffect("Wolf 6");}
        ...
        if(id==4&&monster.getAID()==1&&RN.nextInt(100)<34){//Wolf
            draw("Angry");
            e.printAngryWolf();
            if(RN.nextInt(2)%2==1){playEffect("Wolf 3");}
            else{playEffect("Wolf 5");}
        ...
        if(id==13&&monster.getAID()==3){
            ...
            println("{Orc} You got me...",30,0,"Orc 6");
        ...
        if(id==14&&monster.getAID()<40&&monster.getAID()%2==0)//Crab
        {
            ...
            {
                draw("Crabshell");mname="Crabshell";
                e.printShellCrab();
        ...
        if(id==14&&monster.getAID()%2!=0)//Crab
        {
            ...
            {
                draw("Angry");draw("Crab");mname="Crab";
                e.printAngryCrab();
    ...
    public void witchPass() throws Exception
    {
        ...
        if(gen.nextInt(100)<=10)
        {
            ...
            if(temp==1)
            {
                ...
                draw("SummerWitch");mname="SummerWitch";
                monster.printStats();
            }
            else if(temp==2)
            {
                ...
                draw("FallWitch");mname="FallWitch";
                monster.printStats();
            }
            else if(temp==3)
            {
                ...
                draw("WinterWitch");mname="WinterWitch";
                monster.printStats();
            }
            else if(temp==4)
            {
                ...
                draw("SpringWitch");mname="SpringWitch";
                monster.printStats();
            }
     ...
     */
    public void healthbar() throws Exception{
    ...
    public String getArmorName() throws Exception{
        if(player.tunic()){
            draw("Tunic");return "Tunic";
        }
        else if(player.cloak()){
            draw("Cloak");return "Cloak";
        }
        else if(player.robe()){
            draw("Robe");return "Robe";
        }
        else if(player.cowl()){
            draw("Cowl");return "Cowl";
        }
        else if(player.chestpiece()){
            draw("Chestpiece");return "Chestpiece";
        }
        return "";
    }
    ...
    public boolean printWeapons(String c) throws Exception{
        ...
        if(c.equals("1")){
            ...
            System.out.println("Passive: Basic actions gives wrath stacks.Lose health equal to half of wrath every turn.");
